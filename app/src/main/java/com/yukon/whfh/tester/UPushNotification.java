...
import com.yukon.whfh.helper.PushConstants;
...
public class UPushNotification {
    ...
    public static void send(String ticker, String title, String content) {
        try {
            ...
            msg = new NotificationModel(PushConstants.getAppKey(), PushConstants.getMasterSecret());
