    ...
    public static void init(Context context) {
        ...
        pushAgent.register(new IUmengRegisterCallback() {
            ...
            public void onSuccess(String deviceToken) {
                ...
                pushAgent.setAlias(alias, type, new UTrack.ICallBack() {
                    ...
                    public void onMessage(boolean success, String message) {
                        Log.i(TAG, "cy setAlias " + success + " msg:" + message);
                    }
                });
            }
            ...
            public void onFailure(String errCode, String errDesc) {
                Log.e(TAG, "cy register failure：--> " + "code:" + errCode + ",desc:" + errDesc);
            }
        });
        if (isMainProcess(context)) {
...
//                }
            ...
            public void dealWithNotificationMessage(Context context, UMessage msg) {
                ...
                Log.i(TAG, "cy notification receiver:" + msg.getRaw().toString());
            }
