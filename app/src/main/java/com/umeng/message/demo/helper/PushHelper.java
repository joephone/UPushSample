    ...
    public static void init(Context context) {
        ...
        pushAgent.register(new IUmengRegisterCallback() {
            ...
            public void onSuccess(String deviceToken) {
                ...
                Log.i(TAG, "demo deviceToken --> " + deviceToken);
    ...
    private static void pushAdvancedFunction(Context context) {
        ...
        UmengMessageHandler msgHandler = new UmengMessageHandler() {
            ...
            public void dealWithNotificationMessage(Context context, UMessage msg) {
                ...
                Log.i(TAG, "demo notification receiver:" + msg.getRaw().toString());
            }
            ...
            public void dealWithCustomMessage(Context context, UMessage msg) {
                ...
                Log.i(TAG, "demo custom receiver:" + msg.getRaw().toString());
            }
        };
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            ...
            public void openActivity(Context context, UMessage msg) {
                ...
                Log.i(TAG, "demo click openActivity: " + msg.getRaw().toString());
            }

            @Override
            public void launchApp(Context context, UMessage msg) {
                super.launchApp(context, msg);
                Log.i(TAG, "demo click launchApp: " + msg.getRaw().toString());
            }
